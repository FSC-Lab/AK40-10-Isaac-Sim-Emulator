...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            executable="cable_torque_ctrl_pd_l1_node",
            name="cable_torque_ctrl_pd_l1_node",
            output="screen",
            parameters=[os.path.join(pkg, "config", "cable_torque_ctrl_pd_l1_params.yaml")],
            remappings=[
                ("~/cable_state",       ["/", cable_ctrl_node, "/cable_state"]),
